...
def latex_escape_text(text: str) -> str:
    """Escape characters that are special in LaTeX text nodes."""
...
\draw[green!60!black, dashed, line width=0.4pt]
  ...
  \node[anchor=south east, scale=0.7, gray!60] at ({_fmt(width_in - 0.05)},{_fmt(0.05)}) {{{latex_escape_text("Generated by kdp_cover.py")}}};
\end{{tikzpicture}}
\end{{document}}
"""
