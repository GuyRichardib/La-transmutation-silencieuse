...
- `.github/workflows/build.yml` : pipeline CI qui installe Python, Pandoc et les paquets TeX Live nécessaires (`texlive-latex-base`, `texlive-latex-recommended`, `texlive-latex-extra`, `texlive-fonts-recommended`, `texlive-xetex`) avant de lancer la compilation et d'uploader les artefacts.
